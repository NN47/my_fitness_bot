...
quick_actions_inline = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text="💧 +250", callback_data="quick_water_250"),
...
water_amount_menu = ReplyKeyboardMarkup(
    keyboard=[
        ...
        [KeyboardButton(text="1000"), KeyboardButton(text="1500"), KeyboardButton(text="-250"), KeyboardButton(text="2000")],
        [KeyboardButton(text="⬅️ Назад")],
    ],
    resize_keyboard=True,
)
