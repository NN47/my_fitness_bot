...
quick_actions_inline = InlineKeyboardMarkup(
    inline_keyboard=[
        [
            InlineKeyboardButton(text="💧", callback_data="quick_water_250"),
            InlineKeyboardButton(text="🍱", callback_data="quick_meal_add"),
            InlineKeyboardButton(text="🏋️", callback_data="quick_workout_add"),
            InlineKeyboardButton(text="💊", callback_data="quick_supplements"),
            InlineKeyboardButton(text="🙂", callback_data="quick_wellbeing"),
            InlineKeyboardButton(text="⚖️", callback_data="quick_weight"),
            InlineKeyboardButton(text="💆", callback_data="quick_procedure"),
        ],
        [
